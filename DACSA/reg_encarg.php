...
<body>
  <center><h1>Registrar Encargado</h1></center>
  <section class="container col-xs-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
    ...
    <article><br><br>
      <form method="post" action="registrar_cont.php">
        ...
        <input type="text"  name="usuario" placeholder="Nombre de Usuario" maxlength="15" pattern="[A-Za-z0-9]{8,15}|[A-Za-z]{8,15}" class="form-control"><br>
